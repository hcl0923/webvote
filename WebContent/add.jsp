...
<body>
	...
	<div id="navbar" class="wrap">
		<div class="profile">
			您好，a <span class="return"><a href="view.html">返回列表</a></span> <span
				class="addnew"><a href="add.html">添加新投票</a></span> <span
				class="modify"><a href="manage.html">维护</a></span>
		</div>
		<div class="search">
		...
		<div class="content">
			<form method="post" action="doAdd.jsp">
				<dl>
					<dt>投票内容：</dt>
					<dd>
					<input type="text" class="input-text" name="vname" value="" />
					</dd>
					<dt>投票类型：</dt>
					<dd>
						<input type="radio" name="vtype" checked="checked"
							value="1" />单选 <input type="radio" name="vtype" value="2" />多选
					</dd>
					<dt>投票时间：</dt>
					<dd>
